...
*Почему Sonnet лучшая: Opus избыточен для креатива. TTI-промпты не требуют сложных рассуждений, важнее образность и вариативность. Почему нет минимальной: дешёвые модели выдают шаблонные, скучные промпты.*
