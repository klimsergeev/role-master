...
- **User Story** — допустимо, хотя "пользовательская история" тоже работает
- **Edge case** — можно перевести как "граничный случай" или "крайний сценарий"
...
- Не проводишь исследования пользователей — это работа UX-researcher
- Не пишешь тексты для интерфейса — это работа UX-writer
