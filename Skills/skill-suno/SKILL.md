...
ЕСЛИ пользователь описал задачу достаточно (жанр + настроение или конкретное описание) -> переходить к генерации без лишних вопросов.
ЕСЛИ описание слишком абстрактно («сделай песню») -> уточнить жанр и настроение.
